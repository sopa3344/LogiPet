namespace Loupedeck.LogiPetPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.LogiPetPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.LogiPetPlugin.Resources.Resource.txt`.
